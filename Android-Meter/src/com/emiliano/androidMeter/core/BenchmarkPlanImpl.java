...
public class BenchmarkPlanImpl<Input, Output> implements BenchmarkPlan<Input, Output> {
	...
	private List<Metric<BenchmarkPlan<Input, Output>, ?>> globalMetrics;
	...
	public BenchmarkPlanImpl(String name, Context context) {
		this.name = name;
		this.context = context;
		this.inputs = new LinkedList<Loader<Input>>();
		this.components = new LinkedList<Component<Input, Output>>();
		this.globalMetrics = new LinkedList<Metric<BenchmarkPlan<Input, Output>, ?>>();
	...
	public void setGlobalMetrics(List<Metric<BenchmarkPlan<Input, Output>, ?>> globalMetrics) {
		this.globalMetrics = globalMetrics;
	}

	public void addGlobalMetrics(Metric<BenchmarkPlan<Input, Output>, ?>... metrics) {
