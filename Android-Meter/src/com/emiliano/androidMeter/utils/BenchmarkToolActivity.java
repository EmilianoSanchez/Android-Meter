...
import com.emiliano.androidMeter.R;
...
public abstract class BenchmarkToolActivity<Input, Output> extends Activity implements ExecutorListener {
	...
	protected BenchmarkPlan<Input, Output>[] plans;

	protected abstract BenchmarkPlan<Input, Output>[] getBenchmarkPlans();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.benchmark_tool_activity);
		// listView = (ListView) this.findViewById(R.id.listView);
	}

	public void executePlan(View view) {
		executor = getExecutor(this);
		plans = getBenchmarkPlans();
	...
	public void onPreExecute() {
		...
		progressDialog.setTitle("Benchmark plan progress");
		progressDialog.setMessage("Starting benchmark plan");
		progressDialog.show();
	}
