...
public class ConnectionState {
	...
	public String toString() {
		return this.networkState.toString() + " " + this.networkGroup.toString() + " " + this.networkType.toString()
				+ " Link speed:" + this.linkSpeed;
	}
