...
public class MemSize<Input, Output> implements Metric<TestPlan<Input, Output>> {

	private static int[] mapping;
	
	static{
		mapping=new int[ModelEnum.values().length];
		mapping[ModelEnum.Lenovo_K50_T5.ordinal()]=1886;
		mapping[ModelEnum.GT_I9300.ordinal()]=820;
		mapping[ModelEnum.C2104.ordinal()]=829;
	}
